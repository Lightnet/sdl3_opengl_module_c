...
int main() {
    ...
    float font_size = 20.0f * main_scale;
    ImFont* my_font = ImFontAtlas_AddFontFromFileTTF(fonts, "Kenney Mini.ttf", font_size, NULL, ImFontAtlas_GetGlyphRangesDefault(fonts));
